...
import { EntityId, Target, Weapon, World } from "../world/types";
...
import { getTranslation, standardFormatKeypad, world2keypadStrings } from "../world/transformations";
...
const weaponOptions = [
  ...
  //["hellCannon", "Hell Cannon^tm", "options/mortarRound10.png"],
]
